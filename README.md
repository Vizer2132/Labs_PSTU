...
|  17 |  л/р №?? "линейный интерполяционный бинарный поиск подстроки"      | невыполнено |   |
|  18 |  л/р №?? "поиск подстроки в строке сложные и наивный"  |  только код |  [ссылка на репозиторий](https://github.com/Vizer2132/Labs_PSTU/tree/main/second_semestr/Labs/searching_substring_in_string) |
